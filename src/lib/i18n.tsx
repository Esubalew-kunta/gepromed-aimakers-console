...
const DICT = {
  ...
  "engineering.eyebrow": { fr: "Ingénierie", en: "Engineering" },
  "engineering.title": { fr: "Demandes d'ingénierie", en: "Engineering requests" },
  "engineering.description": {
    fr: "Analyse d'explants, plateforme de tests et location d'équipement : chaque demande suit son propre parcours (l'analyse d'explants comporte un cas hospitalier et un cas industriel), à l'image du board trainees.",
    en: "Explant analysis, testing platform and equipment rental: each request is tracked through its own pipeline (explant has a hospital and an industrial case), mirroring the trainee board.",
  },
  "engineering.notConfigured": {
    fr: "Supabase n'est pas configuré, renseignez les clés dans .env.local pour charger les demandes en direct.",
    en: "Supabase isn't configured, set the keys in .env.local to load live requests.",
  },
  "engineering.empty": {
    fr: "Aucune demande pour ce parcours. Les demandes du site web apparaissent ici.",
    en: "No requests for this pipeline. Requests from the website appear here.",
  },
  "engineering.case": { fr: "Cas :", en: "Case:" },
  "engineering.caseInstitution": { fr: "Institution", en: "Institution" },
  "engineering.caseIndustrial": { fr: "Industriel", en: "Industrial" },
  "engineering.reopen": { fr: "Rouvrir", en: "Reopen" },
  ...
  // Engineering — detail drawer
  "engineering.drawer.contact": { fr: "Contact", en: "Contact" },
  "engineering.drawer.institution": { fr: "Institution", en: "Institution" },
  "engineering.drawer.orgType": { fr: "Type d'organisation", en: "Organisation type" },
  "engineering.drawer.desiredDate": { fr: "Créneau souhaité", en: "Desired slot" },
  "engineering.drawer.details": { fr: "Détails", en: "Details" },
  "engineering.drawer.notes": { fr: "Notes", en: "Notes" },
  "engineering.drawer.noNotes": { fr: "Aucune note.", en: "No notes." },
  "engineering.drawer.meta": { fr: "Champs complémentaires", en: "Additional fields" },
  "engineering.drawer.progress": { fr: "Parcours", en: "Pipeline" },
  "engineering.drawer.timeline": { fr: "Chronologie", en: "Timeline" },
  "engineering.drawer.created": { fr: "Créée le", en: "Created" },
  "engineering.drawer.updated": { fr: "Mise à jour le", en: "Updated" },
  "engineering.drawer.exitedOn": { fr: "Sortie le", en: "Exited" },
  "engineering.drawer.reminders": { fr: "Relances", en: "Reminders" },
  "engineering.drawer.remindersOn": { fr: "Actives", en: "Active" },
  "engineering.drawer.remindersOff": { fr: "Désactivées", en: "Off" },
  "engineering.drawer.actions": { fr: "Actions", en: "Actions" },
  "engineering.drawer.pickCase": {
    fr: "Choisissez le cas pour dérouler le bon parcours :",
    en: "Pick the case to run the right pipeline:",
  },
  "engineering.drawer.close": { fr: "Fermer", en: "Close" },

  // Engineering — KPIs + filters (Phase 3)
  "engineering.kpi.total": { fr: "Demandes", en: "Requests" },
  "engineering.kpi.active": { fr: "En cours", en: "Active" },
  "engineering.kpi.done": { fr: "Terminées", en: "Done" },
  "engineering.kpi.exited": { fr: "Sorties", en: "Exited" },
  "engineering.search": { fr: "Rechercher (réf, nom, email, institution)", en: "Search (ref, name, email, institution)" },
  "engineering.allStages": { fr: "Toutes les étapes", en: "All stages" },
  "engineering.allStatuses": { fr: "Tous les statuts", en: "All statuses" },
  "engineering.status.active": { fr: "En cours", en: "Active" },
  "engineering.status.done": { fr: "Terminées", en: "Done" },
  "engineering.status.exited": { fr: "Sorties", en: "Exited" },
  "engineering.dateFrom": { fr: "Du", en: "From" },
  "engineering.dateTo": { fr: "Au", en: "To" },
  "engineering.noMatch": { fr: "Aucune demande ne correspond aux filtres.", en: "No request matches the filters." },

  // Engineering — stats + comments (Phase 4)
  "engineering.stats.title": { fr: "Statistiques", en: "Statistics" },
  "engineering.stats.byStage": { fr: "Par étape", en: "By stage" },
  "engineering.stats.byStatus": { fr: "Par statut", en: "By status" },
  "engineering.stats.byMonth": { fr: "Demandes par mois", en: "Requests by month" },
  "engineering.drawer.email": { fr: "E-mail au demandeur", en: "Email to requester" },
  "engineering.drawer.emailHint": {
    fr: "Modèle prêt pour cette étape — modifiable avant envoi.",
    en: "Ready-made template for this stage — editable before sending.",
  },
  "engineering.drawer.emailSubject": { fr: "Objet", en: "Subject" },
  "engineering.drawer.emailBody": { fr: "Message", en: "Message" },
  ...
  "engineering.drawer.emailNone": {
    ...
    en: "No template email for this stage.",
  },
  "engineering.drawer.comments": { fr: "Commentaires", en: "Comments" },
  "engineering.drawer.noComments": { fr: "Aucun commentaire.", en: "No comments yet." },
  "engineering.drawer.commentPlaceholder": { fr: "Ajouter un commentaire…", en: "Add a comment…" },
  "engineering.drawer.commentSend": { fr: "Publier", en: "Post" },
} as const;
