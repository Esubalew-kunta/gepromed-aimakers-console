...
const BASE_SELECT =
  "*, trainings(title,summary,specialty,level,deposit_eur,price_eur,capacity,enrolled,city,start_date,end_date,duration_days,program_type,is_sponsored,sponsors), lead_comments(id,author,body,created_at), documents(id,file_url,sign_channel,signed,verified,verified_at,created_at), lead_events(id,type,payload,created_at), email_log(id,template,to_email,status,sent_at)";
